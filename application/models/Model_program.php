...
class Model_program extends CI_Model
{
    ...
    public function getAllprogram()
   {
      ...
      $query = "SELECT * from tb_program_kerja";
   ...
   {
      $this->db->delete('tb_program_kerja', ['id_program' => $id]);
   }
   ...
   {
      return $this->db->get_where('tb_program_kerja', ['id_program' => $id])->row_array();
   }
	...
	public function updateprogram()
   {
      ...
      $this->db->update('tb_program_kerja', $data, ['id_program' => $this->input->post('id_program')]);
   }
