        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?= $jenis_cetakan = $this->uri->segment(5); ?> Anggaran Biaya</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                 ...
                 <?php
					 ...
					 foreach ($query->result() as $row)
				      {	 
						...
						if($jenis_cetakan == "Rencana"){
							$volume=$row->volume_item;
							$jumlah_harga=$row->jumlah_harga;
						}
						if($jenis_cetakan == "Realisasi"){
							$volume=$row->volume_item_terealisasi;
							$jumlah_harga=$row->jumlah_harga_terealisasi;
						}
						if($jenis_cetakan == "Amandemen"){
							$volume=$row->volume_item_terealisasi - $row->volume_item;
							$jumlah_harga=$row->jumlah_harga_terealisasi - $row->jumlah_harga;
						}
				...
				<center>
					<a href="<?= base_url('rab/pdf_kkp/c_rab/') .$id_utama; ?>" class="btn btn-primary" target="_blank">Cetak PDF</a>
				</center>
				</body>
