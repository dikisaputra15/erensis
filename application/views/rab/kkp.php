...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">KKP</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">KKP</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
			<div class="card card-primary">
              ...
              <div class="col-md-2">
                 <div class="form-group">
                   <label for="exampleInputPassword1">Tarif Awal2</label>
                ...
                <div class="col-md-2">
                <div class="form-group">
                   <label for="exampleInputPassword1">Daya Awal2</label>
                ...
                <div class="col-md-2">
                <div class="form-group">
                   <label for="exampleInputPassword1">Tarif Akhir2</label>
                ...
                <div class="col-md-2">
                 <div class="form-group">
                   <label for="exampleInputPassword1">Daya Akhir2</label>
              ...
              <div class="col-md-2">
                 <div class="form-group">
                   <label for="exampleInputPassword1">Tarif Awal3</label>
                ...
                <div class="col-md-2">
                <div class="form-group">
                   <label for="exampleInputPassword1">Daya Awal3</label>
                ...
                <div class="col-md-2">
                <div class="form-group">
                   <label for="exampleInputPassword1">Tarif Akhir3</label>
                ...
                <div class="col-md-2">
                 <div class="form-group">
                   <label for="exampleInputPassword1">Daya Akhir3</label>
              ...
              <div class="col-md-2">
                 <div class="form-group">
                   <label for="exampleInputPassword1">Tarif Awa4l</label>
              ...
              <?php  if($utama['delta_daya'] > 0 && $rasio < 100 && $rasio >= 0){ ?>
              <div class="card-body">
              		<div class="form-group">
                  ...
                  <?php
                    ...
                    $daya_awal_pb[0]=0;
                    $daya_akhir_pb[0]=0;
                    $jumlah_pelanggan_pb[0]=0;
                    $rp_tarif_pb[0]=0;

                    $daya_awal_pb[1]=0;
                    $daya_akhir_pb[1]=0;
                    $jumlah_pelanggan_pb[1]=0;
                    $rp_tarif_pb[1]=0;
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Direkomendasikan untuk penyesuaian daya dimohon dengan rincian sebagai berikut :</label>
                  </div>
                  ...
                  ?>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Premium dengan Selisih BP - INV dibebankan pelanggan sebesar</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="Rp <?= number_format($prem, 0, ",", "."); ?>" readonly>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Sharing investasi minimal sebesar</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="Rp <?= number_format($prem, 0, ",", "."); ?>" readonly>
                  </div>
              <?php }
            ...
            <?php if ($JN_1tahun_bronze<=720 && $JN_1tahun_bronze>0){?>
                   <div class="form-group">
                    <label for="exampleInputEmail1">Tarif daya sesuai permohonan dengan ketentuan</label>
            ...
            <center>
              <a href="<?= base_url('rab/pdf_kkp/c_kkp/') . $utama['id_utama']; ?>" class="btn btn-primary" target="_blank">Cetak Pdf</a>
            </center>
</div>
</div>
</div>
